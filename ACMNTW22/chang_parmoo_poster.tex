...
%  background=shade-tb,
  ...
  % Eye Catcher
  {\includegraphics[height=6em]{Argonne_cmyk_black.eps}} % No eye catcher for this poster. If an eye catcher is present, the title is centered between eye-catcher and logo.
  % Title
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \]
  \begin{center}
  \includegraphics[width=\textwidth]{des-obj-space.png}
  \end{center}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \]
  \begin{center}
  \includegraphics[width=\textwidth]{des-sim-obj-space.png}
  \end{center}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \end{itemize}
  \begin{center}
  \includegraphics[width=0.38\textwidth]{logo-ParMOO.png}
  \hskip 24pt
  \includegraphics[width=0.18\textwidth]{logo-py.png}
  \hskip 24pt
  \includegraphics[width=0.08\textwidth]{logo-gh.png}
  \end{center}
}
