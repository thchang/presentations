...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \setlength{\parskip}{0.5\baselineskip}
  The {\sl MDML} is a Kafka based platform for streaming, analyzing, and
  logging experiment and simulation data
  \begin{center}
  \includegraphics[width=0.8\textwidth]{../img/moo_new/MDML_arch_v2.png}
  \end{center}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{itemize}
    \item \GREEN{Search/sample} raw \BLUE{experimental data}
    \item Use \GREEN{surrogates} to model \BLUE{experiments}
    \item Define \RED{objectives + constraints} on \BLUE{experiments}
    \item Use multiobjective \GREEN{acquisition functions} to set targets
    \item \GREEN{Solve acquisition on surrogates} $\Rightarrow$ next \BLUE{experiment}
  \end{itemize}
  \begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{posterbox}[name=ampl,column=1,row=0]{Our framework and software stack}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \setlength{\parskip}{0.5\baselineskip}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Download ParMOO}{name=code,column=2,row=0}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \setlength{\parskip}{0.5\baselineskip}
  \begin{itemize}[nosep]
